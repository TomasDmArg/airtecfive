...
export default function Page() {
    ...
    const getDescuento = (precio: number, getTotal: boolean): number => {
        if (getTotal) {
            let res = precio;
    ...
    const total = (selected[0]?.precio ?? 0) + (selected[1]?.precio ?? 0);
        ...
        <main>
            ...
            <section>
                ...
                <section className={styles.form}>
                    ...
                    <h3 className={styles.detail}>
                        Descuento: $
                        {getDescuento(total, false).toFixed(2)}
                        ARS
                    </h3>
                </section>
                    ...
                    <Button
                        ...
                        onClick={async () => {
                            if (selected[0] && selected[1]) {
                                ...
                                const reservas = [
                                    {
                                        vuelo: selected[0].num_vuelo,
                                        pasajero: pasajeros[0].id,
                                        n_asiento: reservationData.num_asientoIda,
                                    },
                                    {
                                        vuelo: selected[1].num_vuelo,
                                        pasajero: pasajeros[0].id,
                                        n_asiento: reservationData.num_asientoVuelta,
                                    },
                                ];
